...
### Descargas Oficiales
Obtén la compilación para tu plataforma desde la [última versión]([https://github.com/CSA-DanielVillamizar/agent-foundry-app/releases](https://github.com/CSA-DanielVillamizar/agent-foundry-app//releases/tag/v0.3.0)):
